const nameGirl = 'Bạn nhỏ xinh xinh <3';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng người ấy';
const contentCard = 'Châu Âu ngủ, Châu Á cũng đang ngủ, Châu Mỹ đang tối dần, chỉ có đôi mắt đẹp nhất trên thế giới này đang đọc tin nhắn của mình. chúc bạn 20/10 thật đặc biệt và mãi tỏa sáng trước mọi thứ nhé <3';
